...
readr::write_tsv(strain_isotype %>% dplyr::select(strain, isotype), "processed/strain_isotype_full.tsv",  na = "NA")
...
df <- readr::read_tsv("raw/concordance_strain.tsv") %>%
      ...
      dplyr::mutate(abs_concordance = 1- (discordance / 1589559)) %>%
